#Ejercicio para imprimir los 10 primeros números pares  
#Aún asi vamos a intentar de que la persona pueda ingresar el numero siempre y cuando sea positivo
x=int(input("Bienvenido! Este programa te permite mostrar los 10 primeros números pares positivos de un número. Por favor ingresa el número positivo: "))
n=10
if x < 0:
